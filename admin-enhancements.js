(()=> {
  ...
  function loadStudyRoutineModule(){if(document.querySelector('script[data-mpc-study-routine]'))return;const script=document.createElement('script');script.src='/admin-study-routine.js?v=20260812-5';script.defer=true;script.dataset.mpcStudyRoutine='1';document.body.appendChild(script)}
