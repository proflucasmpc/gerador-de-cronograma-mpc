(()=>{
  ...
  function addStyles(){
    ...
    const style=document.createElement('style');style.id='mpcPublicExperienceStyles';style.textContent=`
      ...
      .mpc-personal-cta .mpc-personal-kicker{display:block;color:var(--gold);font-size:11px;font-weight:950;letter-spacing:.12em;text-transform:uppercase;margin-bottom:5px}.mpc-personal-cta h2{font-family:Georgia,"Times New Roman",serif;font-size:30px;line-height:1.08;margin:0 0 8px;color:#fff}.mpc-personal-cta p{margin:0;max-width:720px;color:#fff;font-size:14px;opacity:.94}.mpc-personal-cta a{display:inline-flex;align-items:center;justify-content:center;min-height:50px;padding:13px 18px;border-radius:10px;background:var(--gold);color:var(--navy3);font-weight:950;text-align:center;white-space:nowrap;box-shadow:0 9px 22px rgba(0,0,0,.14)}.mpc-free-explainer{font-weight:900}
      ...
      body[data-public-theme="aulacerta"] .hero,body[data-public-theme="aulacerta"] .final-banner,body[data-public-theme="aulacerta"] .mpc-personal-cta{background:linear-gradient(145deg,#10234A,#315EFB)}body[data-public-theme="aulacerta"] .header-generator-cta,body[data-public-theme="aulacerta"] .btn-free{background:linear-gradient(135deg,#315EFB,#173BC0);border-color:#6E8AFF}body[data-public-theme="aulacerta"] .mentoria-fixed{background:#10B981;border-bottom-color:#07865E}body[data-public-theme="aulacerta"] .mentoria-kicker{color:#10B981}
      @media(max-width:880px){body{padding-bottom:0!important}.shell{padding-bottom:28px!important}.whatsapp-float{display:none!important}.mobile-nav{position:static!important;left:auto!important;right:auto!important;bottom:auto!important;width:100%!important;margin:26px 0 12px!important;display:grid!important;grid-template-columns:repeat(4,minmax(0,1fr))!important;border-radius:15px!important;box-shadow:0 10px 28px rgba(7,18,37,.16)!important}.mpc-personal-cta{grid-template-columns:1fr;padding:22px 18px;margin-top:12px}.mpc-personal-cta h2{font-size:26px}.mpc-personal-cta a{width:100%;white-space:normal}}
  ...
  function personalCta(){let cta=document.getElementById('mpcPersonalScheduleCta');if(cta)return cta;const shell=document.querySelector('main.shell');if(!shell)return null;cta=document.createElement('section');cta.id='mpcPersonalScheduleCta';cta.className='mpc-personal-cta';cta.innerHTML=`<div><span class="mpc-personal-kicker">Serviço personalizado</span><h2>Quer um cronograma feito especificamente para você?</h2><p>Aqui é diferente do gerador gratuito: o Prof. Lucas analisa seu objetivo, sua rotina, sua disponibilidade e o conteúdo da prova para preparar pessoalmente o seu planejamento.</p></div><a href="${PERSONAL_URL}" target="_blank" rel="noopener">SOLICITAR MEU CRONOGRAMA PERSONALIZADO</a>`;shell.appendChild(cta);return cta}
  function moveMobileMenuAboveCta(){const nav=document.querySelector('.mobile-nav'),cta=personalCta(),shell=document.querySelector('main.shell');if(!nav||!cta||!shell)return;shell.insertBefore(nav,cta)}
  function apply(plan={}){addStyles();applyTheme(plan.publicTheme||'masculino');removeFloatingWhatsapp();clarifyGeneratorCtas();personalCta();moveMobileMenuAboveCta()}
