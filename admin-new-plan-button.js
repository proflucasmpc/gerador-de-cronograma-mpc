(()=>{
  ...
  function mount(){
    ...
    btn.type='button';btn.textContent='CRIAR novo cronograma';
    ...
    btn.addEventListener('click',()=>{
      if(!confirm('Criar um novo cronograma do zero? O cronograma que está aberto no editor será fechado, mas as páginas já publicadas continuarão salvas.'))return;
      clearCurrentPlan();
      location.href='/admin.html?novo=1';
    });
